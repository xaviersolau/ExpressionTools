...
[![codecov](https://codecov.io/github/xaviersolau/ExpressionTools/graph/badge.svg?token=G7Y6IURHRN)](https://codecov.io/github/xaviersolau/ExpressionTools)
...
```bash
Install-Package SoloX.ExpressionTools.Parser -version 1.0.6
Install-Package SoloX.ExpressionTools.Transform -version 1.0.6
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.ExpressionTools.Parser --version 1.0.6
dotnet add package SoloX.ExpressionTools.Transform --version 1.0.6
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="SoloX.ExpressionTools.Parser" Version="1.0.6" />
<PackageReference Include="SoloX.ExpressionTools.Transform" Version="1.0.6" />
```
